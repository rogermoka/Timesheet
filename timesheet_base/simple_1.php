			...
			?><table width="100%" border="0" cellspacing="0" cellpadding="0"><?
				?><tr><?
                                    ?><td width="50%" align="left"><?
                                        ?><input id="project_row<? echo $i; ?>" name="project_row<? echo $i; ?>" value="<? echo $matchedPair->projectId; ?>" onChange="onChangeProjectSelect(this.id);" style="width: 100%; /><?
							?><?
						?></td><?
						?><td width="50%" align="left"><?
				...
				?><tr><?
						?><td width="50%" align="left"><?
							?><input type="hidden" id="project_row<? echo $count; ?>" name="project_row<? echo $count; ?>" value="-1" /><?
                                                        ?><select id="projectSelect_row<? echo $count; ?>" name="projectSelect_row<? echo $count; ?>" onselect="onChangeProjectSelect(this.id);" style="width: 100%;" /><?
						?></td><?
						?><td width="50%" align="left"><?
