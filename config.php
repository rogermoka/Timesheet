...
list($qh, $num) = dbQuery("select locale, timezone, timeformat, headerhtml, bodyhtml, footerhtml, " .
		...
		"LDAPBindUsername, LDAPBindPassword, weekstartday , pmMail , autoMail " .
	...
	<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="outer_table">
		...
		<!-- timezone -->
			...
			<tr>
				...
				<td align="left" width="100%">
					Email address for sending the timesheet manually.
				</td>
			</tr>
			<tr>
				<td align="left" class="label" nowrap width="90">
				...
				<td align="left" width="100%">
					<input id="pmMail" type="email" name="pmMail" value="<? echo $resultset["pmMail"]; ?>" style="width:100%;"></input>
				</td>
			</tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="5" class="section_body">	
				...
				<tr>
					...
					<td align="left" width="100%">
						Email address for sending all user's weekly timesheet automatically.
					</td>
				</tr>
				<tr>
					<td align="left" class="label" nowrap width="90">
					...
					<td align="left" width="100%">
						<input id="autoMail" type="email" name="autoMail" value="<? echo $resultset["autoMail"]; ?>" style="width:100%;"></input>
					</td>
				</tr>
